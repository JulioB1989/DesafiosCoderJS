...
$(".infoJuego").append(`<div>
                        <a style="color:red">IR AL JUEGO</a>
                   </div>`);
$('a').click( function(e) { 
    e.preventDefault();
    $('html,body').animate({
        scrollTop: $(".tablero").offset().top  
    }, 2000);
} );

$("#botonDados").delay(5000)
        .slideUp(2000)
        .slideDown(2000);
